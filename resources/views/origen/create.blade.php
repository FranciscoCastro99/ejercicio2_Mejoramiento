...
<body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="{{route('origin.create')}}">Crear</a>
                </li>
            </ul>
          </div>
        </div>
    ...
    <div class="d-flex justify-content-center align-items-center flex-column" style="height: calc(100vh - 56px);">
        <h1 class="mb-3">Crear Origen</h1>
        <form class="w-25" action="{{route('origin.store')}}" method="post">
            @csrf
            ...
            <div class="form-floating mb-3">
                <input name="otros_datos" type="text" class="form-control" id="otros_datos" placeholder="otros_datos">
